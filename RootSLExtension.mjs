...
var en = {
	"RootSLExtension.name": "RootSLExtension",
	"RootSLExtension.doIt": "do it [SCRIPT]"
};
var ja = {
	"RootSLExtension.name": "RootSLExtension",
	"RootSLExtension.doIt": "[SCRIPT] を実行する"
};
var translations = {
	en: en,
	ja: ja,
	"ja-Hira": {
	"RootSLExtension.name": "RootSLExtension",
	"RootSLExtension.doIt": "[SCRIPT] をじっこうする"
}
};
...
var ExtensionBlocks = /*#__PURE__*/function () {
  /**
   * Construct a set of blocks for RootSLExtension.
  ...
  function ExtensionBlocks(runtime) {
    ...
    // Root rt0 用の BLE 通信を管理するインスタンス
    this.rootRt0 = new RootRt0Extension(runtime);
  }
  ...
  return _createClass$1(ExtensionBlocks, [{
    ...
    value: function getInfo() {
      ...
      return {
        ...
        blocks: [{
          ...
          text: formatMessage({
            id: 'RootSLExtension.moveForward',
            default: 'Root rt0を前進させる',
            description: 'move Root rt0 forward'
          }),
          func: 'moveForward'
        }, {
          ...
          text: formatMessage({
            id: 'RootSLExtension.getSensorValue',
            default: 'Root rt0のセンサー値を取得',
            description: 'get sensor value from Root rt0'
          }),
          func: 'getSensorValue'
        }, {
          opcode: 'doIt',
    ...
    key: "moveForward",
    value: function () {
      var _moveForward = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
        return _regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return this.rootRt0.moveForward();
            case 2:
            case "end":
      ...
      function moveForward() {
        return _moveForward.apply(this, arguments);
      }
      return moveForward;
    }() // Root rt0 のセンサー値を取得
  }, {
    key: "getSensorValue",
    value: function () {
      var _getSensorValue = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
        return _regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return this.rootRt0.getSensorValue();
            case 2:
      ...
      function getSensorValue() {
        return _getSensorValue.apply(this, arguments);
      }
...
}(); // Root rt0 用の BLE 通信を管理するクラス
var RootRt0Extension = /*#__PURE__*/function () {
  function RootRt0Extension(runtime) {
  ...
  return _createClass$1(RootRt0Extension, [{
    key: "connect",
    value: function () {
      var _connect = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee3() {
        return _regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 7:
              console.log('Root rt0に接続しました');
              _context3.next = 14;
              break;
            case 10:
              _context3.prev = 10;
              _context3.t0 = _context3["catch"](1);
              console.error('接続エラー:', _context3.t0);
              throw new Error('Root rt0への接続に失敗しました');
            case 14:
            case "end":
    ...
    key: "moveForward",
    value: function () {
      var _moveForward2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee4() {
        var command;
        return _regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              return this.connect();
            case 2:
              command = new Uint8Array([0x01, 0x00, 0x64]); // 仮の前進コマンド
              _context4.prev = 3;
              _context4.next = 6;
              return this.device.writeValue(this.serviceUUID, this.commandUUID, command);
            case 6:
              console.log('前進コマンドを送信しました');
              _context4.next = 12;
              break;
            case 9:
              _context4.prev = 9;
              _context4.t0 = _context4["catch"](3);
              console.error('送信エラー:', _context4.t0);
            case 12:
            case "end":
      ...
      function moveForward() {
        return _moveForward2.apply(this, arguments);
      }
      return moveForward;
    }() // センサー値の取得
  }, {
    key: "getSensorValue",
    value: function () {
      var _getSensorValue2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee5() {
        var value, sensorData;
        return _regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 2:
              _context5.prev = 2;
              _context5.next = 5;
              return this.device.readValue(this.serviceUUID, this.sensorUUID);
            case 5:
              value = _context5.sent;
              sensorData = new Uint8Array(value.buffer); // 受信データをパース
              return _context5.abrupt("return", sensorData[0]);
            case 10:
              _context5.prev = 10;
              _context5.t0 = _context5["catch"](2);
              console.error('受信エラー:', _context5.t0);
      ...
      function getSensorValue() {
        return _getSensorValue2.apply(this, arguments);
      }
      return getSensorValue;
    }()
  }]);
