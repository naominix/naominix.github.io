import require$$4 from 'format-message';
...
var entry = {
  ...
  helpLink: 'https://naominix.github.io/xcx-rootsl-extension/',
...
function requireBlock() {
  ...
  var RootDevice = /*#__PURE__*/function () {
    function RootDevice(runtime, extensionId) {
      _classCallCheck$1(this, RootDevice);
     ...
     */
    return _createClass$1(RootDevice, [{
  ...
  var RootExtension = /*#__PURE__*/function () {
    function RootExtension(runtime) {
      _classCallCheck$1(this, RootExtension);
     ...
     */
    return _createClass$1(RootExtension, [{
      key: "getInfo",
