(function(ext) {
    ...
    ext.headled = function(steps) {
        $.get('http://localhost:8080/headled?steps=' + steps, null, function() {
            console.log('headled ' + steps + ' steps');
        });
    }
    ...
    var locale = {
        ...
        en: {
            ...
            head_led: 'control head led %n %n %n %n'
        },
    }
    ...
    var descriptor = {
        blocks: [
            ...
            [' ', 'MiP: ' + locale[lang].head_led, 'headled']
        ]
    };
